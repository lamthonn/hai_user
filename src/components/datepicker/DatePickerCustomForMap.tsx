...
const DatePickerCustomForMap: FunctionComponent<DatePickerComponentProps> = ({
  label,
      ...
      {mode === "range" ? (
        ...
        //   onPanelChange={handlePanelChange}
          onBlur={()=>{
            ...
            // const date = (value as Dayjs).format("YYYY-MM-DD HH:mm:ss");
            onChange?.(value);
          }}
          placeholder={placeholder ?? placeholderRange[0]}
          value={currentViewDate ?? (value ? (value as Dayjs).format("YYYY-MM-DD HH:mm:ss") : null)}
          onChange={onSingleChange}
          onCalendarChange={onSingleChange}
          //onChange={onChange as DatePickerProps["onChange"]}
          disabled={disabled}
        //   defaultValue={value ? (value as Dayjs).format("YYYY-MM-DD HH:mm:ss") : defaultValue}
          style={style}
          format={format}
...
export default DatePickerCustomForMap;
